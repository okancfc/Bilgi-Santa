export function HowWeMeetBanner() {
  return (
    <section className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="bg-gradient-to-br from-bilgi-red/20 via-dark-card to-gold-accent/10 border border-bilgi-red/30 rounded-3xl p-8 md:p-12 relative overflow-hidden">
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-bilgi-red/10 rounded-full blur-3xl" />
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-3">
                  {[
                    "Belirlenen tarih ve saatte kampüste buluş",
                    "Eşleşme kodunu kullanarak birbirinizi bulun",
                    "Hazırladığın sürpriz hediyeyi ver",
                    "Yeni bir arkadaşlık başlasın!",
                  ].map((item, index) => (
                    <li key={index} className="flex items-center gap-3 text-foreground">
                      <span className="w-6 h-6 rounded-full bg-bilgi-red/20 flex items-center justify-center flex-shrink-0">
                        <svg
              ...
              <div className="flex-1 max-w-md w-full">
                <div className="bg-dark-bg border border-border rounded-2xl p-6 shadow-2xl">
                  ...
                  <div className="mt-4 pt-4 border-t border-border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["Müzik", "Kitap", "Fotoğrafçılık"].map((interest) => (
                        <span
                          key={interest}
                          className="px-3 py-1 bg-bilgi-red/10 text-bilgi-red text-xs rounded-full border border-bilgi-red/30"
                        >
                          {interest}
                        </span>
                      ))}
